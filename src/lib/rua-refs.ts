...
export const RUA_REFS: Record<string, RuaRef[]> = {
  "AA-001": [
    ...
    },
    {
      ...
      "body": "How the governing controls for this task cross-reference to NIST CSF 2.0, so the mentee can speak to both frameworks with one body of evidence.\n\n| Mapped reference | Meaning |\n| NIST CSF 2.0 | ID.AM-01 (Inventories of hardware maintained) |\n| — | ID.AM-02 (Inventories of software maintained) |\n| — | ID.AM-05 (Assets are prioritised). |\n\n## Why it matters\nA single artifact can answer both the governing standard and this framework — the mentee should be able to show one deliverable satisfying both columns.",
      "tab": "study"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Information Asset Register Template. spreadsheet with columns: Asset ID, Asset Name, Asset Type, Owner, Location, Format, CIA Classification, Custodian, Review Date, Notes\n\n## Structure\n| Asset ID | Asset Name | Asset Type | Owner | Location | Format | CIA Classification | Custodian | Review Date | Notes\n\nBlank template — one row per item. Populate during the task.",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "body": "Confirmed IT/Operations contact for the initial systems list\n\n## Why this is required\nConfirms the people, access and time the mentee needs are secured, so the task is not blocked mid-way.\n\n## Gate check\nIf this input is not secured, mark Provided (Y/N) = N and escalate to the mentor — the task cannot pass the RUA gate.",
      "tab": "acquire"
    },
    {
    ...
    },
    {
      ...
      "summary": "Reading that enables the mentee to explain, in their own words: Information asset types: data, software, hardware, services, people and…",
      "body": "A study primer that enables the mentee to explain, in their own words: Information asset types: data, software, hardware, services, people and intangibles.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: The CIA triad (Confidentiality, Integrity, Availability) as the basis…",
      "body": "A study primer that enables the mentee to explain, in their own words: The CIA triad (Confidentiality, Integrity, Availability) as the basis for classification.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Asset ownership versus custodianship — why every asset needs a named owner",
      "body": "A study primer that enables the mentee to explain, in their own words: Asset ownership versus custodianship — why every asset needs a named owner.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: The three-tier classification scheme (Public / Internal / Confidential)…",
      "body": "A study primer that enables the mentee to explain, in their own words: The three-tier classification scheme (Public / Internal / Confidential) under ISO/IEC 27001:2022 Annex A 5.12.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Intent of Annex A 5.9 (asset inventory) and A 8.1 (user endpoint devices)",
      "body": "A study primer that enables the mentee to explain, in their own words: Intent of Annex A 5.9 (asset inventory) and A 8.1 (user endpoint devices).\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "AA-002": [
    {
      ...
      "body": "The governing control references the mentee must study before work begins, drawn from CIS Controls v8 — Governing Control References. Each is shown with its intent.\n\n| Reference | Intent |\n|  | Controls 1–6: Inventory of Enterprise Assets |\n|  | Inventory of Software Assets |\n|  | Data Protection |\n|  | Secure Configuration |\n|  | Account Management |\n|  | Access Control Management (Implementation Group 1 sub-controls only) |\n\n## Reading for the mentee\nUnderstand not just what each reference says but why it applies to this organisation and its regulatory footprint.",
      "tab": "study"
    },
    {
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: CIS Controls v8 IG1 Assessment Worksheet. pre-built spreadsheet with all 56 IG1 Safeguards, status dropdowns, evidence columns, and auto-scoring\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Gap Analysis Report Template. Word with executive summary, findings table, and remediation roadmap sections\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "CIS Controls v8 IG1 Assessment Worksheet reviewed end to end\n\n## Why this is required\nEnsures the mentee has read and understood the supplied templates/tools end to end before using them.\n\n## Gate check\nIf this input is not secured, mark Provided (Y/N) = N and escalate to the mentor — the task cannot pass the RUA gate.",
      "tab": "acquire"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: CIS Controls v8 structure: 18 Controls, safeguards, and Implementation…",
      "body": "A study primer that enables the mentee to explain, in their own words: CIS Controls v8 structure: 18 Controls, safeguards, and Implementation Groups (IG1/IG2/IG3).\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Why IG1's 56 Safeguards represent essential cyber hygiene",
      "body": "A study primer that enables the mentee to explain, in their own words: Why IG1's 56 Safeguards represent essential cyber hygiene.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Assessment statuses: Implemented / Partial / Not Implemented / Not…",
      "body": "A study primer that enables the mentee to explain, in their own words: Assessment statuses: Implemented / Partial / Not Implemented / Not Applicable.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Evidence-based assessment versus self-attestation",
      "body": "A study primer that enables the mentee to explain, in their own words: Evidence-based assessment versus self-attestation.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Compliance percentage scoring per Control group and gap prioritisation…",
      "body": "A study primer that enables the mentee to explain, in their own words: Compliance percentage scoring per Control group and gap prioritisation by risk exposure.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "AA-003": [
    {
      ...
      "body": "The governing control references the mentee must study before work begins, drawn from GDPR (EU) 2016/679 — Governing Control References. Each is shown with its intent.\n\n| Reference | Intent |\n| Article 4 (Definitions | personal data, processing, controller, processor) |\n|  | Article 13 & 14 (Information to be provided) |\n| Article 30 (Records of processing activities | RoPA) |\n|  | Article 35 (Data protection impact assessment screening) |\n\n## Reading for the mentee\nUnderstand not just what each reference says but why it applies to this organisation and its regulatory footprint.",
      "tab": "study"
    },
    {
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: RoPA Template. Article 30-compliant spreadsheet: processing activity, purposes, legal basis, data categories, data subjects, recipients, retention, transfers, security measures\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: DPIA Screening Checklist. nine-criteria Word form\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Data Flow Diagram Template. Visio/draw.io swimlane template\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: GDPR Article 4 definitions: personal data, processing, controller, processor",
      "body": "A study primer that enables the mentee to explain, in their own words: GDPR Article 4 definitions: personal data, processing, controller, processor.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: The six lawful bases for processing under Article 6",
      "body": "A study primer that enables the mentee to explain, in their own words: The six lawful bases for processing under Article 6.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Records of Processing Activities (RoPA) under Article 30 — purpose and…",
      "body": "A study primer that enables the mentee to explain, in their own words: Records of Processing Activities (RoPA) under Article 30 — purpose and mandatory fields.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: DPIA screening: the nine-criteria test per EDPB guidelines (Article 35)",
      "body": "A study primer that enables the mentee to explain, in their own words: DPIA screening: the nine-criteria test per EDPB guidelines (Article 35).\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Cross-border transfer basics and third-party recipients",
      "body": "A study primer that enables the mentee to explain, in their own words: Cross-border transfer basics and third-party recipients.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "GRM-001": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Risk Register Template. spreadsheet: Risk ID, Description, Threat Source, Asset Affected, Existing Controls, Likelihood, Impact, Inherent Score, Risk Category, Treatment Option, Risk Owner, Target Residual Score, Review Date\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: 5×5 Risk Matrix Reference Card.\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Risk Identification Workshop Guide.\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Threat, vulnerability, likelihood and impact, and how they combine into…",
      "body": "A study primer that enables the mentee to explain, in their own words: Threat, vulnerability, likelihood and impact, and how they combine into a risk score.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Inherent versus residual risk and the effect of existing controls",
      "body": "A study primer that enables the mentee to explain, in their own words: Inherent versus residual risk and the effect of existing controls.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: The 5×5 risk matrix and Critical / High / Medium / Low categorisation",
      "body": "A study primer that enables the mentee to explain, in their own words: The 5×5 risk matrix and Critical / High / Medium / Low categorisation.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: STRIDE-lite prompt categories for structured risk identification",
      "body": "A study primer that enables the mentee to explain, in their own words: STRIDE-lite prompt categories for structured risk identification.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Risk treatment options: accept, mitigate, transfer, avoid (ISO 27001…",
      "body": "A study primer that enables the mentee to explain, in their own words: Risk treatment options: accept, mitigate, transfer, avoid (ISO 27001 Clauses 6.1.2 and 6.1.3).\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "GRM-002": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Policy Template. Word document with standard headers: Document Control, Purpose, Scope, Definitions, Policy Statements, Roles and Responsibilities, Exceptions, Related Documents, Review History\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Policy Review Comment Sheet.\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Policy Approval and Sign-Off Form.\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "kind": "Template / Working Document",
      "summary": "spreadsheet",
      "body": "Working template the mentee obtains and reviews: Policy Register. spreadsheet\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Policy versus procedure versus standard versus guideline",
      "body": "A study primer that enables the mentee to explain, in their own words: Policy versus procedure versus standard versus guideline.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: ISO 27001:2022 Clause 5.2 requirements for an information security policy",
      "body": "A study primer that enables the mentee to explain, in their own words: ISO 27001:2022 Clause 5.2 requirements for an information security policy.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Mapping policy statements to Annex A controls (A 5.1, A 6.7, A 8.1)",
      "body": "A study primer that enables the mentee to explain, in their own words: Mapping policy statements to Annex A controls (A 5.1, A 6.7, A 8.1).\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Document control basics: versioning, review cycles, the Policy Register",
      "body": "A study primer that enables the mentee to explain, in their own words: Document control basics: versioning, review cycles, the Policy Register.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: The structured review cycle: reviewer roles, comment sheets, approval…",
      "body": "A study primer that enables the mentee to explain, in their own words: The structured review cycle: reviewer roles, comment sheets, approval and sign-off.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "GRM-003": [
    {
      ...
      "body": "The governing control references the mentee must study before work begins, drawn from NIST CSF 2.0 — Governing Control References. Each is shown with its intent.\n\n| Reference | Intent |\n|  | Tier Definitions (Tier 1 Partial → Tier 4 Adaptive) |\n| GV.OC | Organizational Context |\n| GV.RM | Risk Management Strategy |\n| GV.PO | Policy |\n\n## Reading for the mentee\nUnderstand not just what each reference says but why it applies to this organisation and its regulatory footprint.",
      "tab": "study"
    },
    {
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: NIST CSF 2.0 Maturity Assessment Questionnaire. Word — 6 Function tabs, 10–15 questions each with Tier anchors\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: CSF Maturity Spider Diagram. Excel — auto-plots from scores\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Maturity Assessment Report Template. Word with cover page, scoring table, diagram placeholder, and roadmap section\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: The six NIST CSF 2.0 Functions: Govern, Identify, Protect, Detect,…",
      "body": "A study primer that enables the mentee to explain, in their own words: The six NIST CSF 2.0 Functions: Govern, Identify, Protect, Detect, Respond, Recover.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Tier definitions: 1 Partial, 2 Risk-Informed, 3 Repeatable, 4 Adaptive",
      "body": "A study primer that enables the mentee to explain, in their own words: Tier definitions: 1 Partial, 2 Risk-Informed, 3 Repeatable, 4 Adaptive.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Maturity versus compliance — why they are different measurements",
      "body": "A study primer that enables the mentee to explain, in their own words: Maturity versus compliance — why they are different measurements.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Interview-based scoring with Tier anchors and justification notes",
      "body": "A study primer that enables the mentee to explain, in their own words: Interview-based scoring with Tier anchors and justification notes.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Current-state versus target-state profiling and the spider diagram",
      "body": "A study primer that enables the mentee to explain, in their own words: Current-state versus target-state profiling and the spider diagram.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "CRM-001": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Regulatory Obligations Register Template. spreadsheet: Obligation ID, Source/Regulation, Specific Requirement, Jurisdiction, Applicability Rationale, ISO 27001 Mapping, Control Owner, Compliance Status, Evidence Reference, Gap Flag, Next Review Date\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "kind": "Template / Working Document",
      "summary": "Word",
      "body": "Working template the mentee obtains and reviews: Regulatory Scoping Interview Guide. Word\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Four obligation categories: legislation, sector-specific regulation,…",
      "body": "A study primer that enables the mentee to explain, in their own words: Four obligation categories: legislation, sector-specific regulation, contractual obligations, voluntary standards.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: ISO 27001 Clauses 4.1 and 4.2 — organisational context and interested…",
      "body": "A study primer that enables the mentee to explain, in their own words: ISO 27001 Clauses 4.1 and 4.2 — organisational context and interested parties.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Annex A 5.31 — legal, statutory, regulatory and contractual requirements",
      "body": "A study primer that enables the mentee to explain, in their own words: Annex A 5.31 — legal, statutory, regulatory and contractual requirements.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Applicability rationale — documenting why an obligation applies",
      "body": "A study primer that enables the mentee to explain, in their own words: Applicability rationale — documenting why an obligation applies.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Compliance status ratings (Met / Partial / Gap) and review scheduling",
      "body": "A study primer that enables the mentee to explain, in their own words: Compliance status ratings (Met / Partial / Gap) and review scheduling.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "CRM-002": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: ISO 27001 Control Applicability Matrix Template. Excel — 93 Annex A controls as rows, business processes as columns, with status dropdowns and auto-gap count\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Control Applicability Worksheet. Word — per-process question prompts\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: NIST CSF to ISO 27001 Cross-Walk Reference Sheet.\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: ISO 27001:2022 Annex A structure: 93 controls across Organisational…",
      "body": "A study primer that enables the mentee to explain, in their own words: ISO 27001:2022 Annex A structure: 93 controls across Organisational (37), People (8), Physical (14), Technological (34) themes.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Control applicability rationale: applicable / not applicable / partially…",
      "body": "A study primer that enables the mentee to explain, in their own words: Control applicability rationale: applicable / not applicable / partially applicable.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Process view versus control view of an organisation",
      "body": "A study primer that enables the mentee to explain, in their own words: Process view versus control view of an organisation.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: The control matrix as a process × control grid and its relationship to…",
      "body": "A study primer that enables the mentee to explain, in their own words: The control matrix as a process × control grid and its relationship to the Statement of Applicability.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Implementation status evidence and control ownership",
      "body": "A study primer that enables the mentee to explain, in their own words: Implementation status evidence and control ownership.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "CRM-003": [
    {
      ...
      "body": "The governing control references the mentee must study before work begins, drawn from SOC 2 Type II (AICPA Trust Services Criteria) — Governing Control References. Each is shown with its intent.\n\n| Reference | Intent |\n| CC1–CC9 (Common Criteria | Security) |\n| A1 (Availability | awareness) |\n| C1 (Confidentiality | awareness) |\n\n## Reading for the mentee\nUnderstand not just what each reference says but why it applies to this organisation and its regulatory footprint.",
      "tab": "study"
    },
    {
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: SOC 2 Common Criteria Mapping Template. spreadsheet: CC ID, Criterion Description, Example Audit Test, Internal Control Reference, Evidence Type, Gap Flag, RAG Status\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: SOC 2 Awareness Briefing Template. Word, 2-page format\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Sample anonymised SOC 2 Type II report. provided by mentor for learning purposes\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: SOC 1 versus SOC 2 versus SOC 3, and Type I versus Type II",
      "body": "A study primer that enables the mentee to explain, in their own words: SOC 1 versus SOC 2 versus SOC 3, and Type I versus Type II.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Trust Services Criteria categories; Security (Common Criteria) as the…",
      "body": "A study primer that enables the mentee to explain, in their own words: Trust Services Criteria categories; Security (Common Criteria) as the mandatory category.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Common Criteria CC1–CC9 and their COSO Framework foundation",
      "body": "A study primer that enables the mentee to explain, in their own words: Common Criteria CC1–CC9 and their COSO Framework foundation.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Auditor opinions, exceptions and what they signal",
      "body": "A study primer that enables the mentee to explain, in their own words: Auditor opinions, exceptions and what they signal.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Mapping criteria to internal controls and RAG readiness summaries",
      "body": "A study primer that enables the mentee to explain, in their own words: Mapping criteria to internal controls and RAG readiness summaries.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "DD-001": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Procedure Template. Word — with standard headers: Purpose, Scope, Definitions, Procedure Steps, Responsibilities, Related Documents, Document Control\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Incident Reporting Quick Reference Card Template. A5 Word layout\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Staff Communication Template. 50-word email announcement\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Security event versus security incident — definitions and examples",
      "body": "A study primer that enables the mentee to explain, in their own words: Security event versus security incident — definitions and examples.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Annex A 6.8 (event reporting), A 5.26 (incident response) and A 5.28…",
      "body": "A study primer that enables the mentee to explain, in their own words: Annex A 6.8 (event reporting), A 5.26 (incident response) and A 5.28 (evidence collection) intent.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Procedure structure: purpose, scope, definitions, steps,…",
      "body": "A study primer that enables the mentee to explain, in their own words: Procedure structure: purpose, scope, definitions, steps, responsibilities, document control.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Reporting channels and escalation timelines",
      "body": "A study primer that enables the mentee to explain, in their own words: Reporting channels and escalation timelines.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Writing for all staff: plain language and the one-page quick reference…",
      "body": "A study primer that enables the mentee to explain, in their own words: Writing for all staff: plain language and the one-page quick reference discipline.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "DD-002": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Training Content Outline Template. Word — with topic, learning objective, key messages, and timing per section\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Security Awareness Slide Deck Template. PowerPoint — branded, 12-slide structure\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Knowledge Check Template. Word — 5-question MCQ with answer key\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Facilitator Guide Template. Word — A4 one-pager\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "kind": "Template / Working Document",
      "summary": "spreadsheet",
      "body": "Working template the mentee obtains and reviews: Training Attendance Register Template. spreadsheet\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Measurable learning objectives and how they drive content design",
      "body": "A study primer that enables the mentee to explain, in their own words: Measurable learning objectives and how they drive content design.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Adult-learning basics: relevance, brevity, plain language, engagement",
      "body": "A study primer that enables the mentee to explain, in their own words: Adult-learning basics: relevance, brevity, plain language, engagement.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Core messages for phishing recognition, password hygiene and data handling",
      "body": "A study primer that enables the mentee to explain, in their own words: Core messages for phishing recognition, password hygiene and data handling.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Knowledge-check design: aligned questions, plausible distractors, answer…",
      "body": "A study primer that enables the mentee to explain, in their own words: Knowledge-check design: aligned questions, plausible distractors, answer keys.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Annex A 6.3 awareness and training obligations",
      "body": "A study primer that enables the mentee to explain, in their own words: Annex A 6.3 awareness and training obligations.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "DD-003": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Data Retention Schedule Template. spreadsheet: Data Element, Data Category, System/Location, Retention Trigger, Retention Period, Legal Basis, Disposal Method, Disposal Responsible, Last Review, Next Review, Notes\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Data Disposal Instruction Template. Word — one-pager per disposal method\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Legal Retention Reference Sheet. jurisdiction-specific summary — provided by mentor\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: GDPR Article 5(1)(e) storage limitation and Recital 39",
      "body": "A study primer that enables the mentee to explain, in their own words: GDPR Article 5(1)(e) storage limitation and Recital 39.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Retention trigger versus retention period (e.g. end of employment + 6 years)",
      "body": "A study primer that enables the mentee to explain, in their own words: Retention trigger versus retention period (e.g. end of employment + 6 years).\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Sources of legal retention minimums: employment, tax and sector-specific law",
      "body": "A study primer that enables the mentee to explain, in their own words: Sources of legal retention minimums: employment, tax and sector-specific law.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Disposal methods per medium and documented disposal instructions",
      "body": "A study primer that enables the mentee to explain, in their own words: Disposal methods per medium and documented disposal instructions.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Interplay with Article 17 right to erasure and its exemptions",
      "body": "A study primer that enables the mentee to explain, in their own words: Interplay with Article 17 right to erasure and its exemptions.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "SPA-001": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: GRC Roadmap Template. Excel — Gantt chart with action IDs, descriptions, phase, owner, control reference, start/end dates, status, and estimated effort\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Management Briefing Template. Word — one-page format: context, priorities, investment summary, next steps\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: GRC Action Detail Sheet. spreadsheet supporting the Gantt\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Phased planning: Quick Wins (0–3 months), Medium-Term (3–6), Longer-Term…",
      "body": "A study primer that enables the mentee to explain, in their own words: Phased planning: Quick Wins (0–3 months), Medium-Term (3–6), Longer-Term (6–12).\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: ISO 27001 Clause 6.2 — objectives and planning to achieve them",
      "body": "A study primer that enables the mentee to explain, in their own words: ISO 27001 Clause 6.2 — objectives and planning to achieve them.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Effort-versus-impact prioritisation and dependency sequencing",
      "body": "A study primer that enables the mentee to explain, in their own words: Effort-versus-impact prioritisation and dependency sequencing.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Gantt basics: milestones, owners, phases, status",
      "body": "A study primer that enables the mentee to explain, in their own words: Gantt basics: milestones, owners, phases, status.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Estimating compliance uplift and writing an investment rationale for…",
      "body": "A study primer that enables the mentee to explain, in their own words: Estimating compliance uplift and writing an investment rationale for management.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "SPA-002": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Stakeholder Register Template. spreadsheet: Stakeholder ID, Name/Group, Role, Interest Area, Influence Level 1–5, Interest Level 1–5, Quadrant, Engagement Strategy, Communication Channel, Frequency, Owner\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Influence-Interest Matrix Template. PowerPoint 2×2 diagram\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Stakeholder Communication Plan Template. Word table format\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Interested parties under ISO 27001 Clause 4.2 and roles under Clause 5.3",
      "body": "A study primer that enables the mentee to explain, in their own words: Interested parties under ISO 27001 Clause 4.2 and roles under Clause 5.3.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Influence versus interest and the 2×2 Influence-Interest Matrix",
      "body": "A study primer that enables the mentee to explain, in their own words: Influence versus interest and the 2×2 Influence-Interest Matrix.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Quadrant strategies: Manage Closely / Keep Satisfied / Keep Informed /…",
      "body": "A study primer that enables the mentee to explain, in their own words: Quadrant strategies: Manage Closely / Keep Satisfied / Keep Informed / Monitor.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Stakeholder registers and communication planning (what, how often, which…",
      "body": "A study primer that enables the mentee to explain, in their own words: Stakeholder registers and communication planning (what, how often, which channel).\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Internal versus external stakeholder identification",
      "body": "A study primer that enables the mentee to explain, in their own words: Internal versus external stakeholder identification.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "IE-001": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Control Implementation Tracker Template. spreadsheet: Safeguard ID, Description, IT Owner, Target Date, Status, Evidence Reference, Acceptance Criteria, Pass/Fail, Notes\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Implementation Task Card Template. Word — one card per control\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Evidence Repository Folder Structure Guide. naming conventions and filing instructions\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: The remediation lifecycle: select, plan, implement, evidence, verify, close",
      "body": "A study primer that enables the mentee to explain, in their own words: The remediation lifecycle: select, plan, implement, evidence, verify, close.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Acceptance criteria — defining done before work starts",
      "body": "A study primer that enables the mentee to explain, in their own words: Acceptance criteria — defining done before work starts.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Implementation evidence types: screenshots, configuration exports,…",
      "body": "A study primer that enables the mentee to explain, in their own words: Implementation evidence types: screenshots, configuration exports, policy documents.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Raising and escalating remediation issues when acceptance fails",
      "body": "A study primer that enables the mentee to explain, in their own words: Raising and escalating remediation issues when acceptance fails.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Keeping the tracker current and updating the AA-002 gap analysis on…",
      "body": "A study primer that enables the mentee to explain, in their own words: Keeping the tracker current and updating the AA-002 gap analysis on completion.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "IE-002": [
    ...
    },
    {
      ...
      "kind": "Template / Working Document",
      "summary": "Word",
      "body": "Working template the mentee obtains and reviews: Document Control Policy Template. Word\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Document Register Template. spreadsheet: Doc ID, Title, Version, Status, Owner, Approver, Date Approved, Next Review Date, Location Link\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: GRC Folder Structure Guide. Word — recommended hierarchy and naming conventions\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Version Numbering Guide. reference card\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Clause 7.5 / 7.5.3 — creating, updating and controlling documented…",
      "body": "A study primer that enables the mentee to explain, in their own words: Clause 7.5 / 7.5.3 — creating, updating and controlling documented information.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Version numbering schemes: major versus minor versions",
      "body": "A study primer that enables the mentee to explain, in their own words: Version numbering schemes: major versus minor versions.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Naming conventions and folder hierarchy design",
      "body": "A study primer that enables the mentee to explain, in their own words: Naming conventions and folder hierarchy design.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Document lifecycle: draft, review, approved, published, retired",
      "body": "A study primer that enables the mentee to explain, in their own words: Document lifecycle: draft, review, approved, published, retired.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: The Document Register as the master index with owners and review dates",
      "body": "A study primer that enables the mentee to explain, in their own words: The Document Register as the master index with owners and review dates.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "TV-001": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Access Review Worksheet. spreadsheet: Account ID, Username, System, Role/Permission Level, Last Login Date, HR Status, Finding Type, Recommended Action, Priority, IT Owner Action\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Access Control Testing Report Template. Word — executive summary, findings table, remediation recommendations, sign-off block\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Cross-Reference Methodology Guide.\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Least privilege and role-based access (Annex A 5.18, 8.2, 8.3, 8.5)",
      "body": "A study primer that enables the mentee to explain, in their own words: Least privilege and role-based access (Annex A 5.18, 8.2, 8.3, 8.5).\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Joiner–mover–leaver lifecycle and where access errors creep in",
      "body": "A study primer that enables the mentee to explain, in their own words: Joiner–mover–leaver lifecycle and where access errors creep in.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Orphaned versus dormant versus mismatched accounts",
      "body": "A study primer that enables the mentee to explain, in their own words: Orphaned versus dormant versus mismatched accounts.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Independent data sources: system extract cross-referenced against HR records",
      "body": "A study primer that enables the mentee to explain, in their own words: Independent data sources: system extract cross-referenced against HR records.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Finding types, priorities and remediation deadlines",
      "body": "A study primer that enables the mentee to explain, in their own words: Finding types, priorities and remediation deadlines.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "TV-002": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Control Testing Workpaper Template. Word — Control ID, Control Statement, Test Procedure, Evidence Requested, Evidence Received, Result, Finding Narrative, Recommendation\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Spot-Check Report Template. Word — cover page, scope, methodology, findings summary table, recommendations, appendix\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Compliance Rate Calculator. Excel formula sheet\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Control statements: specific, observable, testable assertions derived…",
      "body": "A study primer that enables the mentee to explain, in their own words: Control statements: specific, observable, testable assertions derived from policy text.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Evidence sampling: what to request, sample size, and period covered",
      "body": "A study primer that enables the mentee to explain, in their own words: Evidence sampling: what to request, sample size, and period covered.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Test techniques: inquiry versus inspection of evidence",
      "body": "A study primer that enables the mentee to explain, in their own words: Test techniques: inquiry versus inspection of evidence.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Result categories: compliant / partially compliant / non-compliant",
      "body": "A study primer that enables the mentee to explain, in their own words: Result categories: compliant / partially compliant / non-compliant.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Compliance rate calculation and remediation recommendations (Annex A 5.36)",
      "body": "A study primer that enables the mentee to explain, in their own words: Compliance rate calculation and remediation recommendations (Annex A 5.36).\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "MM-001": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: KPI Definition Card Template. Word — one card per KPI: name, formula, data source, frequency, owner, target, RAG thresholds, chart type\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Monthly GRC Metrics Tracking Spreadsheet Template. Excel — auto-RAG, 12-month rolling, trend sparklines\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: GRC Metrics Report Template. Word — one-page: RAG dashboard, commentary, actions required\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: KPI versus KRI, and leading versus lagging indicators",
      "body": "A study primer that enables the mentee to explain, in their own words: KPI versus KRI, and leading versus lagging indicators.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: KPI anatomy: name, formula, data source, frequency, owner, target, RAG…",
      "body": "A study primer that enables the mentee to explain, in their own words: KPI anatomy: name, formula, data source, frequency, owner, target, RAG thresholds.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Data source reliability and collection effort",
      "body": "A study primer that enables the mentee to explain, in their own words: Data source reliability and collection effort.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: ISO 27001 Clause 9.1 monitoring and measurement requirements",
      "body": "A study primer that enables the mentee to explain, in their own words: ISO 27001 Clause 9.1 monitoring and measurement requirements.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Interpreting RAG status into management commentary",
      "body": "A study primer that enables the mentee to explain, in their own words: Interpreting RAG status into management commentary.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "MM-002": [
    ...
    },
    {
      ...
      "kind": "Template / Working Document",
      "summary": "Word",
      "body": "Working template the mentee obtains and reviews: Risk Register Review Meeting Agenda Template. Word\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Risk Register. reuse from GRM-001 template — version controlled\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Monthly Risk Summary Template. Word — one-page: portfolio table, RAG movement arrows, narrative commentary\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Risk Register Version Control Log. spreadsheet tab\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Risk registers as live artefacts: re-scoring triggers and treatment progress",
      "body": "A study primer that enables the mentee to explain, in their own words: Risk registers as live artefacts: re-scoring triggers and treatment progress.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Residual risk movement and portfolio-level interpretation",
      "body": "A study primer that enables the mentee to explain, in their own words: Residual risk movement and portfolio-level interpretation.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Meeting facilitation: agenda discipline, pre-reading, real-time capture",
      "body": "A study primer that enables the mentee to explain, in their own words: Meeting facilitation: agenda discipline, pre-reading, real-time capture.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Consistent entry format for newly identified risks",
      "body": "A study primer that enables the mentee to explain, in their own words: Consistent entry format for newly identified risks.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Version control of the register and evidence filing",
      "body": "A study primer that enables the mentee to explain, in their own words: Version control of the register and evidence filing.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "CA-001": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Pre-Session Communication Template. email — 3-paragraph format\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Knowledge Check Answer Sheet. Word — participant copy\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Knowledge Check Marking Sheet. mentor copy with answers\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Training Completion Report Template. Word — one-page: date, attendees, pass rate, findings, recommendations\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Presenting technical content to a non-technical audience",
      "body": "A study primer that enables the mentee to explain, in their own words: Presenting technical content to a non-technical audience.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Session logistics: room/video setup, equipment testing, timing to 30 minutes",
      "body": "A study primer that enables the mentee to explain, in their own words: Session logistics: room/video setup, equipment testing, timing to 30 minutes.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Administering and scoring the five-question knowledge check (target ≥80%…",
      "body": "A study primer that enables the mentee to explain, in their own words: Administering and scoring the five-question knowledge check (target ≥80% pass).\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Attendance registers and training completion records as audit evidence…",
      "body": "A study primer that enables the mentee to explain, in their own words: Attendance registers and training completion records as audit evidence under Annex A 6.3.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Handling questions and unexpected disruptions gracefully",
      "body": "A study primer that enables the mentee to explain, in their own words: Handling questions and unexpected disruptions gracefully.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "CA-002": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Executive Compliance Status Report Template. Word — one-page with: header RAG indicator, top-3 risks table, top-3 achievements, open decisions table, 30-day outlook text box\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Plain-English GRC Writing Guide. reference card — 10 rules for writing for non-technical audiences\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Synthesis versus detail: choosing the five messages that matter to…",
      "body": "A study primer that enables the mentee to explain, in their own words: Synthesis versus detail: choosing the five messages that matter to management.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Overall RAG status and how it is justified",
      "body": "A study primer that enables the mentee to explain, in their own words: Overall RAG status and how it is justified.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Plain-English writing: concrete numbers, no jargon",
      "body": "A study primer that enables the mentee to explain, in their own words: Plain-English writing: concrete numbers, no jargon.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Structure of the one-page report: risks, achievements, open decisions,…",
      "body": "A study primer that enables the mentee to explain, in their own words: Structure of the one-page report: risks, achievements, open decisions, 30-day outlook.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: ISO 27001 Clause 9.3 management review inputs",
      "body": "A study primer that enables the mentee to explain, in their own words: ISO 27001 Clause 9.3 management review inputs.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "CA-003": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Stakeholder Interview Guide Template. Word — with interview purpose, rapport-building opener, 8–10 structured questions per role type, and closing prompt\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Stakeholder Interview Summary Template. Word — one-page per interview: key quotes, concerns, knowledge gaps, priorities\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Stakeholder Needs Discovery Report Template. Word — themes table, implications, recommendations\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Structured versus unstructured interviews and why structure aids comparison",
      "body": "A study primer that enables the mentee to explain, in their own words: Structured versus unstructured interviews and why structure aids comparison.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Open questions, follow-up probes and avoiding leading questions",
      "body": "A study primer that enables the mentee to explain, in their own words: Open questions, follow-up probes and avoiding leading questions.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Active listening and structured note-taking",
      "body": "A study primer that enables the mentee to explain, in their own words: Active listening and structured note-taking.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Thematic analysis across multiple interviews: concerns, gaps, priorities",
      "body": "A study primer that enables the mentee to explain, in their own words: Thematic analysis across multiple interviews: concerns, gaps, priorities.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Interviewer neutrality and building rapport",
      "body": "A study primer that enables the mentee to explain, in their own words: Interviewer neutrality and building rapport.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "RR-001": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Tabletop Observation Sheet. Word — with sections: timeline log, decision log, escalation log, communication gaps, resource gaps, deviations from procedure\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Post-Exercise Lessons Learned Report Template. Word — exercise summary, observations, top-3 improvements, procedure amendment proposals, sign-off\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Tabletop Scenario Brief Template. provided by Incident Response & Crisis Manager mentor\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Purpose of tabletop exercises: testing decisions and communication, not…",
      "body": "A study primer that enables the mentee to explain, in their own words: Purpose of tabletop exercises: testing decisions and communication, not technology.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: The observer role: capture, do not participate in decisions",
      "body": "A study primer that enables the mentee to explain, in their own words: The observer role: capture, do not participate in decisions.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Structured observation: timeline, decision, escalation and communication…",
      "body": "A study primer that enables the mentee to explain, in their own words: Structured observation: timeline, decision, escalation and communication logs.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Lessons-learned discipline under Annex A 5.27 and the 48-hour write-up…",
      "body": "A study primer that enables the mentee to explain, in their own words: Lessons-learned discipline under Annex A 5.27 and the 48-hour write-up window.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Turning observations into procedure amendment proposals",
      "body": "A study primer that enables the mentee to explain, in their own words: Turning observations into procedure amendment proposals.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "BCRP-001": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: BIA Questionnaire Template. Word — structured questions: function identification, dependencies, financial impact, operational impact, RTO/RPO estimation, workarounds, IT systems required\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: BIA Summary Table Template. Excel — function, impact score, RTO, RPO, dependency, single point of failure, workaround\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: BIA Report Template. Word — standard BC report format\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: RTO/RPO Definition Reference Card.\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Critical functions and how criticality is determined",
      "body": "A study primer that enables the mentee to explain, in their own words: Critical functions and how criticality is determined.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Dependency mapping: people, systems, data, suppliers",
      "body": "A study primer that enables the mentee to explain, in their own words: Dependency mapping: people, systems, data, suppliers.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: RTO (Recovery Time Objective) versus RPO (Recovery Point Objective)…",
      "body": "A study primer that enables the mentee to explain, in their own words: RTO (Recovery Time Objective) versus RPO (Recovery Point Objective) versus maximum tolerable downtime.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: How impact escalates over time (hours versus days)",
      "body": "A study primer that enables the mentee to explain, in their own words: How impact escalates over time (hours versus days).\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Single points of failure and credible workarounds (Annex A 5.29, 5.30)",
      "body": "A study primer that enables the mentee to explain, in their own words: Single points of failure and credible workarounds (Annex A 5.29, 5.30).\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "BCRP-002": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: ICT DR Checklist Template. Word — four sections: Preparation, Incident Declaration, Restoration Steps, Return to Normal; each step has: step number, action, responsible person, expected outcome, actual outcome, sign-off\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: DR Documentation Library Filing Guide. Word — where to store and version DR artefacts\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Backup types, schedules and verification — why an untested backup is a…",
      "body": "A study primer that enables the mentee to explain, in their own words: Backup types, schedules and verification — why an untested backup is a hope, not a control.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Failover versus restoration",
      "body": "A study primer that enables the mentee to explain, in their own words: Failover versus restoration.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: DR checklist structure: Preparation, Incident Declaration, Restoration,…",
      "body": "A study primer that enables the mentee to explain, in their own words: DR checklist structure: Preparation, Incident Declaration, Restoration, Return to Normal.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: RTO/RPO from the BIA as measurable success criteria (Annex A 5.30, 8.13,…",
      "body": "A study primer that enables the mentee to explain, in their own words: RTO/RPO from the BIA as measurable success criteria (Annex A 5.30, 8.13, 8.14).\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Talk-through testing versus live restoration testing",
      "body": "A study primer that enables the mentee to explain, in their own words: Talk-through testing versus live restoration testing.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "TPRM-001": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Supplier Register Template. spreadsheet: Vendor ID, Vendor Name, Service, Data Access Type, System Access, Criticality Score, Location, Certification Held, Composite Risk Rating, DPA Status, Contract Expiry, Primary Contact, Notes\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Five-Criterion Risk Rating Guide. Word — criteria definitions and scoring anchors\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: High-Risk Vendor Summary Template. Word — one-page alert format\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Why third parties are a risk channel: data access, system access,…",
      "body": "A study primer that enables the mentee to explain, in their own words: Why third parties are a risk channel: data access, system access, criticality.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: The five-criterion risk rating model and composite Low/Medium/High scoring",
      "body": "A study primer that enables the mentee to explain, in their own words: The five-criterion risk rating model and composite Low/Medium/High scoring.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Data access levels: none / view / process / store",
      "body": "A study primer that enables the mentee to explain, in their own words: Data access levels: none / view / process / store.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Data-processing agreements under GDPR Article 28 — when they are required",
      "body": "A study primer that enables the mentee to explain, in their own words: Data-processing agreements under GDPR Article 28 — when they are required.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Vendor discovery sources: contracts, accounts payable, IT records (Annex…",
      "body": "A study primer that enables the mentee to explain, in their own words: Vendor discovery sources: contracts, accounts payable, IT records (Annex A 5.19–5.22).\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "TPRM-002": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Vendor Security Questionnaire Template. Word — 25 questions covering: information security policy, access management, incident response, business continuity, subprocessors, certifications, physical security, network security, encryption, data deletion\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Due-Diligence Assessment Report Template. Word — vendor summary, questionnaire score, gap table, risk rating, recommended mitigations, sign-off\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "kind": "Template / Working Document",
      "summary": "reference card",
      "body": "Working template the mentee obtains and reviews: Due-Diligence Scoring Guide. reference card\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Customising a standard questionnaire to the vendor's service and data…",
      "body": "A study primer that enables the mentee to explain, in their own words: Customising a standard questionnaire to the vendor's service and data footprint.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Assessing response credibility: specific, evidenced answers versus vague…",
      "body": "A study primer that enables the mentee to explain, in their own words: Assessing response credibility: specific, evidenced answers versus vague assurances.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Reliance on certifications (ISO 27001, SOC 2) and its limits",
      "body": "A study primer that enables the mentee to explain, in their own words: Reliance on certifications (ISO 27001, SOC 2) and its limits.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Mapping responses to Annex A controls and flagging gaps",
      "body": "A study primer that enables the mentee to explain, in their own words: Mapping responses to Annex A controls and flagging gaps.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Due-diligence scoring and professional vendor communication",
      "body": "A study primer that enables the mentee to explain, in their own words: Due-diligence scoring and professional vendor communication.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "LRC-001": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Privacy Notice Gap-Check Checklist. Word — 14 mandatory elements with checklist column, notes column, and gap flag\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Privacy Notice Template. Word — GDPR-compliant structure covering all Article 13/14 elements in plain language\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Plain Language Writing Guide. reference card — 10 rules for accessible legal drafting\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Sector Benchmark Privacy Notice. anonymised example — provided by mentor\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Article 13 (data collected from the subject) versus Article 14 (data…",
      "body": "A study primer that enables the mentee to explain, in their own words: Article 13 (data collected from the subject) versus Article 14 (data obtained indirectly).\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: The 14 mandatory privacy notice elements in the gap-check checklist",
      "body": "A study primer that enables the mentee to explain, in their own words: The 14 mandatory privacy notice elements in the gap-check checklist.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Plain language and readability: Flesch-Kincaid Grade 8 target",
      "body": "A study primer that enables the mentee to explain, in their own words: Plain language and readability: Flesch-Kincaid Grade 8 target.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Layered notice design and sector good practice",
      "body": "A study primer that enables the mentee to explain, in their own words: Layered notice design and sector good practice.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: The Legal/DPO review and sign-off role",
      "body": "A study primer that enables the mentee to explain, in their own words: The Legal/DPO review and sign-off role.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "PE-001": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Project Charter Template. Word — background, objectives, success criteria, scope, out-of-scope, deliverables, team, governance, risks/assumptions, sign-off block\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Milestone Gantt Template. Excel — 6-month view with milestone diamonds, owner, and status\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Kick-Off Meeting Agenda Template. Word — standard agenda with attendees, objectives, roles, questions, next steps\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "kind": "Template / Working Document",
      "summary": "Excel",
      "body": "Working template the mentee obtains and reviews: RACI Matrix Template. Excel\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: The project charter as the initiative's authorising document",
      "body": "A study primer that enables the mentee to explain, in their own words: The project charter as the initiative's authorising document.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Scope and out-of-scope discipline — preventing scope creep at day one",
      "body": "A study primer that enables the mentee to explain, in their own words: Scope and out-of-scope discipline — preventing scope creep at day one.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Success criteria versus deliverables",
      "body": "A study primer that enables the mentee to explain, in their own words: Success criteria versus deliverables.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Governance roles: sponsor, project lead, workstream owners (Clause 5.3)",
      "body": "A study primer that enables the mentee to explain, in their own words: Governance roles: sponsor, project lead, workstream owners (Clause 5.3).\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Milestone-level planning versus task-level planning, and initial risk…",
      "body": "A study primer that enables the mentee to explain, in their own words: Milestone-level planning versus task-level planning, and initial risk identification.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "PE-002": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Audit Evidence Requirements List. Word — per ISO 27001 clause: control objective, expected evidence types, evidence quality criteria\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Evidence Labelling Convention Guide. Word — naming syntax and folder structure\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Evidence Index Template. spreadsheet: Evidence ID, Control Reference, Evidence Description, Source, Date, Collected By, Quality Check Status, Location\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Audit Evidence Checklist. Word — quality-check criteria per evidence item\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Evidence quality: relevance, sufficiency, reliability, currency",
      "body": "A study primer that enables the mentee to explain, in their own words: Evidence quality: relevance, sufficiency, reliability, currency.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Evidence types: records, configuration exports, meeting minutes, logs,…",
      "body": "A study primer that enables the mentee to explain, in their own words: Evidence types: records, configuration exports, meeting minutes, logs, approvals.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: The Evidence Labelling Convention and folder structure",
      "body": "A study primer that enables the mentee to explain, in their own words: The Evidence Labelling Convention and folder structure.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: The Evidence Index as the auditor's entry point",
      "body": "A study primer that enables the mentee to explain, in their own words: The Evidence Index as the auditor's entry point.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Mock-audit thinking: what will the auditor ask about each item? (Clause…",
      "body": "A study primer that enables the mentee to explain, in their own words: Mock-audit thinking: what will the auditor ask about each item? (Clause 7.5, Annex A 5.35, 5.36).\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "QA-001": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Document Quality Review Checklist. Word — criteria: document control completeness, version number, approval signatures, scope accuracy, policy statement completeness, control references, plain language, review date currency\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Correction Request Form. Word — Correction ID, Document, Section, Deficiency Description, Severity, Recommended Action, Due Date, Resolved Y/N\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Correction Tracking Log. Excel — Correction ID, status, document owner, resolution date\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Quality Review Closure Report Template. Word — one-page summary\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Document quality criteria: document control completeness, versioning,…",
      "body": "A study primer that enables the mentee to explain, in their own words: Document quality criteria: document control completeness, versioning, approvals, scope accuracy, control references, plain language, review currency.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Major versus Minor deficiency classification",
      "body": "A study primer that enables the mentee to explain, in their own words: Major versus Minor deficiency classification.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: The Correction Request workflow: raise, discuss, track, re-check, close",
      "body": "A study primer that enables the mentee to explain, in their own words: The Correction Request workflow: raise, discuss, track, re-check, close.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Reviewer objectivity and constructive feedback to document owners",
      "body": "A study primer that enables the mentee to explain, in their own words: Reviewer objectivity and constructive feedback to document owners.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Clauses 7.5.2 / 7.5.3 as the quality baseline",
      "body": "A study primer that enables the mentee to explain, in their own words: Clauses 7.5.2 / 7.5.3 as the quality baseline.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "QA-002": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Control Testing Methodology Sheet Template. Word — Control ID, Control Objective, Test Approach, Test Steps (numbered), Evidence Required, Evidence Quality Criteria, Pass/Fail Criteria, Frequency, Testing Owner\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Testing Methodology Overview Template. Word — sampling rationale, frequency schedule, documentation standards, escalation path\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Audit Standard Reference Extract. excerpts from ISAE 3000, IIA Standards — provided by mentor\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Test approaches: inquiry, observation, inspection, re-performance — and…",
      "body": "A study primer that enables the mentee to explain, in their own words: Test approaches: inquiry, observation, inspection, re-performance — and when each suffices.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Sampling: rationale, size and period",
      "body": "A study primer that enables the mentee to explain, in their own words: Sampling: rationale, size and period.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Unambiguous pass/fail criteria",
      "body": "A study primer that enables the mentee to explain, in their own words: Unambiguous pass/fail criteria.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Repeatability and defensibility — another tester must reach the same result",
      "body": "A study primer that enables the mentee to explain, in their own words: Repeatability and defensibility — another tester must reach the same result.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: How professional audit firms document comparable tests (Clause 9.1,…",
      "body": "A study primer that enables the mentee to explain, in their own words: How professional audit firms document comparable tests (Clause 9.1, Annex A 5.35, 5.36).\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "KT-001": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: New Joiner GRC Reference Guide Template. Word — 4-page, with visual icons, colour-coded sections, and plain language\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: New Joiner GRC Checklist Template. Word — Day 1/7/30 table format, with manager and employee columns\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Day-1 Security Briefing Slide Deck Template. PowerPoint — 5-slide structure: welcome, key policies, how to report, data rules, who to call\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Knowledge curation: the ten things every joiner must know",
      "body": "A study primer that enables the mentee to explain, in their own words: Knowledge curation: the ten things every joiner must know.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Day-1 / Day-7 / Day-30 sequencing of GRC actions",
      "body": "A study primer that enables the mentee to explain, in their own words: Day-1 / Day-7 / Day-30 sequencing of GRC actions.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Visual, plain-language design within a four-page limit",
      "body": "A study primer that enables the mentee to explain, in their own words: Visual, plain-language design within a four-page limit.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Employment-lifecycle controls: Annex A 6.1, 6.2, 6.3, 6.6",
      "body": "A study primer that enables the mentee to explain, in their own words: Employment-lifecycle controls: Annex A 6.1, 6.2, 6.3, 6.6.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Designing for handover: HR must be able to maintain the pack",
      "body": "A study primer that enables the mentee to explain, in their own words: Designing for handover: HR must be able to maintain the pack.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ],
  "KT-002": [
    ...
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Lessons Learned Worksheet. Word — structured reflection questions: learning, successes, challenges, recommendations\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Lessons Learned Report Template. Word — introduction, key learnings table, programme improvement recommendations, portfolio index page\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
      ...
      "body": "Working template the mentee obtains and reviews: Mentee Portfolio Index Template. spreadsheet: Task ID, Task Name, Deliverable, File Location, Date Completed, Badge Earned\n\n## Typical structure\n- Purpose & scope — what the document is for and its boundary\n- Structured content — the fields / sections completed during the task\n- Owner & review — who maintains it and the review cadence",
      "tab": "inspect"
    },
    {
    ...
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Retrospective structure: what was learned, what worked, what did not,…",
      "body": "A study primer that enables the mentee to explain, in their own words: Retrospective structure: what was learned, what worked, what did not, what to recommend.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Lessons versus complaints — actionable, evidence-based reflection",
      "body": "A study primer that enables the mentee to explain, in their own words: Lessons versus complaints — actionable, evidence-based reflection.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: ISO 27001 Clause 10.1 continual improvement applied to the programme itself",
      "body": "A study primer that enables the mentee to explain, in their own words: ISO 27001 Clause 10.1 continual improvement applied to the programme itself.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: The Mentee Portfolio Index as evidence of capability",
      "body": "A study primer that enables the mentee to explain, in their own words: The Mentee Portfolio Index as evidence of capability.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    },
    {
      ...
      "kind": "Concept Study Material",
      "summary": "Reading that enables the mentee to explain, in their own words: Writing for the next cohort as the audience",
      "body": "A study primer that enables the mentee to explain, in their own words: Writing for the next cohort as the audience.\n\n## In plain terms\nThe mentee should be able to state what this concept means, why it matters to the task, and give a concrete example — rather than reciting a definition. Being able to teach it back in plain language is the test of understanding.\n\n## Watch out for\nReciting a textbook definition without being able to give a concrete, organisation-specific example.",
      "tab": "explain"
    }
  ]
};
